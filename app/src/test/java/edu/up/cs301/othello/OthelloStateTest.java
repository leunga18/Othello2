...
public class OthelloStateTest {
    ...
    public void testValidPlacePiece(){
        OthelloState o = new OthelloState();
        assertNotEquals(0, o.placePiece(2,3,OthelloState.BLACK, false));
    }
